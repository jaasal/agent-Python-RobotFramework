...
class Variables(object):
    ...
    def check_variables():
        ...
        Variables.launch_rerun_id = get_variable("RP_LAUNCH_RERUN_UUID", default=None)
        Variables.launch_doc = get_variable("RP_LAUNCH_DOC", default=None)
        Variables.launch_rerun = bool(get_variable("RP_LAUNCH_RERUN", default=False))
